...
import net.betechs.mns.stock.entites.dep_fam_poste_liv.FamilleController;
import net.betechs.mns.stock.entites.emp_article.util.JsfUtil;
import net.betechs.mns.stock.entites.emp_article.util.JsfUtil.PersistAction;
...
//        tocreate.setArticlePK(new us.pastec.mns.stock.entites.emp_article.ArticlePK());
    ...
    public net.betechs.mns.stock.entites.emp_article.ArticleFacade getEjbFacade() {
        return ejbFacade;
    }

    public void setEjbFacade(net.betechs.mns.stock.entites.emp_article.ArticleFacade ejbFacade) {
    ...
    public Article getArticle(net.betechs.mns.stock.entites.emp_article.ArticlePK id) {
    ...
    public static class ArticleControllerConverter implements Converter {
        ...
        net.betechs.mns.stock.entites.emp_article.ArticlePK getKey(String value) {
            net.betechs.mns.stock.entites.emp_article.ArticlePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new net.betechs.mns.stock.entites.emp_article.ArticlePK();
            key.setCodeArticle(Short.parseShort(values[0]));
            key.setCodeFamille(Short.parseShort(values[1]));
            return key;
        }

        String getStringKey(net.betechs.mns.stock.entites.emp_article.ArticlePK value) {
