 ...
 */
package net.betechs.stock.filters;
...
import net.betechs.stock.connexion.ConnexionController;
...
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (connexionController.isConnected() && !connexionController.getUtilisateur().getCodePrivilegeUtilisateur().getCodePrivilege().equals(Short.valueOf("1"))) {
            /* Redirection vers la page publique */
            String acces = ResourceBundle.getBundle("/Bundle").getString("AdminConnectPage");
            wrappedResponse.sendRedirect(wrappedRequest.getContextPath() + acces);
        } else {
